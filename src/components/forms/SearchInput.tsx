...
export const SearchInput = () => {
   ...
   return (
         <label className='border border-gray-300 shadow-lg flex w-[91%] sm:w-[35%] lg:w-[45%] rounded-lg bg-white text-gray-500 justify-center py-1 items-center pr-1 pl-3 gap-2'>
